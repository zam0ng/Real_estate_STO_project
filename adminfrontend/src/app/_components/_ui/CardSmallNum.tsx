    ...
    <>
      <div className="flex items-center justify-between h-14 w-30rem ">
        ...
        <div className="flex flex-col mr-28 ">
          ...
          <p className="text-base font-medium text-dashboard_card_transaction_date">
            {" "}
            May 23,2022 at 8:20 PM{" "}
          </p>
        </div>

        <p className="text-2xl font-semibold tracking-tight text-dashboard_card_transaction_title">
          {" "}
          +$32.50{" "}
        </p>
      </div>
