                  ...
                  <div className="flex-col mt-8 " >
                    ...
                    <div className="flex mt-8" >
                      ...
                      <div className="w-6 h-6 bg-stone-300 rounded-2xl" > </div>
                        <Link href={"/admin/dashboard"} className="ml-5 text-base font-semibold tracking-tight text-adminLayout_menubar_name">
                          대시보드
                        </Link>
                      </div>
                    ...
                    <div className="flex mt-10" >
                      {/* ✅ 아이콘 들어가야 함 */}
                      <div className="w-6 h-6 bg-stone-300 rounded-2xl" > </div>
                        <Link href={"/admin/users"} className="ml-5 text-base font-semibold tracking-tight text-adminLayout_menubar_name">
                          사용자
                        </Link>
                    </div>
                    ...
                    <div className="flex mt-10" >
                      {/* ✅ 아이콘 들어가야 함 */}
                      <div className="w-6 h-6 bg-stone-300 rounded-2xl" > </div>
                        <Link href={"/admin/transactions"} className="ml-5 text-base font-semibold tracking-tight text-adminLayout_menubar_name">
                          거래이력
                        </Link>
                    </div>
                    ...
                    <div className="flex mt-10" >
                      {/* ✅ 아이콘 들어가야 함 */}
                      <div className="w-6 h-6 bg-stone-300 rounded-2xl" > </div>
                        <Link href={"/admin/real_estates"} className="ml-5 text-base font-semibold tracking-tight text-adminLayout_menubar_name">
                          매물관리
                        </Link>
                    </div>
                    ...
                    <div className="flex mt-10" >
                      {/* ✅ 아이콘 들어가야 함 */}
                      <div className="w-6 h-6 bg-stone-300 rounded-2xl" > </div>
                        <Link href={"/admin/notices"} className="ml-5 text-base font-semibold tracking-tight text-adminLayout_menubar_name">
                          게시글
                        </Link> 
                    </div>
