          ...
          <div className="w-full bg-neutral-100">
            <div className="flex flex-col ">
              ...
              <div className="w-auto h-auto bg-pink-300">
                ...
                {/* table 내용 */}
                <div className="grid w-3/4 gap-2 pl-12 pr-12 text-xl tracking-tight text-center bg-white border-b-2 justify-items-center grid-cols-table mx-44">
                  {/* 첫 번째 행 : 구분 기준 */}
                  {/* 구분선 */}
                  <div className="w-full col-span-6 border-t-4 border-collapse border-neutral-200 ">
                    {" "}
                  </div>
                  {/* 구분 요소 나열 */}
