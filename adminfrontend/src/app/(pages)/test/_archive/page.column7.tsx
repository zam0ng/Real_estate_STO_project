          ...
          <div className="w-full bg-neutral-100">
            ...
            <div className="w-auto h-auto bg-pink-300">
              ...
              <div className="grid w-3/4 gap-2 pb-12 pl-12 pr-12 text-xl tracking-tight text-center bg-white border-b-2 rounded-b-3xl justify-items-center grid-cols-table mx-44">
                ...
                {/* 첫 번째 행 : 구분 기준 */}
                  {/* 구분선 */}
                      <div className="w-full col-span-7 border-t-4 border-collapse border-neutral-200 ">  </div>
                  {/* 구분 요소 나열 */}
                ...
                {/* 두 번째 행 : item*/}
                  {/* 구분선 */}
                      <div className="w-full col-span-7 border-t-2 border-collapse border-neutral-100 ">  </div>
                  {/* 아이템 나열 */}
