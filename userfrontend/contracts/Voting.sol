...
contract Voting {
    ...
    event Voted(bool vote, address voter, uint256 usedTokens, uint256 agreeVotes, uint256 disagreeVotes);
    ...
    function vote(bool voteType) public {
        ...
        emit Voted(voteType,msg.sender,usedTokens,agreeVotes,disagreeVotes);
    }
