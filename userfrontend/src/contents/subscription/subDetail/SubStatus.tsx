                ...
                <div className="w-full h-16 mt-3 ">
                    <div className="grid grid-cols-3 h-full ">
                        ...
                        <div className="text-xs col-span-2 text-center pt-2">
                            ...
                            <span className="bg-gray-200 text-blue-400 rounded-sm px-2 py-1 font-bold">{`마감까지 ${formatCurrency(parseInt(detail.subscription_offering_price) *(parseInt(detail.subscription_totalsupply)-parseInt(detail.subscription_order_amount)))}원 남음👏`}</span>
                        </div>
                    </div>
                </div>
                <div className=" ">
