...
const DepositWithdrawalBtn: React.FC = () => {
  ...
  return (
    <div className='w-full h-[20%] flex justify-evenly items-start'>
        <button onClick ={depositBtn}className='w-[40%] h-[50%] border border-black rounded-lg flex flex-row justify-center items-center text-blue-500 bg-slate-100'>
        ...
        <button onClick={withdrawBtn} className='w-[40%] h-[50%] border border-black rounded-lg flex flex-row justify-center items-center text-white bg-blue-500'>
            <svg className='mr-2' xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
