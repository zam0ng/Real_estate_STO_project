...
const MyAssetHistoryTableBody: React.FC<AssetTableBodyProps> = ({name,price,amount,valuation,present_price,possible_quantity,rate_of_return}) => {
    return (
        <div className='w-[90%] h-[25%] border border-black flex flex-row'>
            <div className='w-[30%] h-full border-r border-black flex justify-center items-center'>
                {name}
            </div>
            <div className='w-1/5 h-full border-r border-black flex flex-col'>
            ...
            <div className='w-1/5 h-full border-r border-black'>
