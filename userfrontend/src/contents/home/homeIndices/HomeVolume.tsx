        ...
        { volume && volume.map((item: HomeChartType, index: number) => {
            return (
                <div className={`border-b border-black-200 w-full h-14 flex`} key={index}>
                        ...
                        <div className="w-12 h-12 border border-blue-500 rounded-full m-1" style={{background : `url(http://localhost:8080/estate_img/${item['Subscription.subscription_img_1']})`, backgroundSize : 'cover' }}></div>
                        <div className="mt-1">
