...
const PropertyDetail: React.FC = () => {
  ...
  const propertyDetailIcon: React.ReactNode[] = [
    ...
    (<svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
      <path d="M12 20.8334V10.4167" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M18 20.8334V4.16675" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M6 20.8334V16.6667" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>)
  ];

  return (
    <div className='w-full h-72 border border-black flex flex-col items-center justify-evenly'>
