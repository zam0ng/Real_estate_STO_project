  ...
  try {
    ...
    const result = await db.Subscriptions.findOne({
      attributes: [
        "id",
        "subscription_img_1",
        "subscription_img_1_2",
        "subscription_img_1_3",
        "subscription_img_1_4",
        "subscription_img_1_5",
        "subscription_name",
...
export const realEstateSubmit = async (req: Request, res: Response) => {
  ...
  try {
    const result = await Subscriptions.create({
      ...
      subscription_img_1_2: img,
      subscription_img_1_3: img,
      subscription_img_1_4: img,
      subscription_img_1_5: img,
