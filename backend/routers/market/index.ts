...
import {marketSubscription, marketTradelist, marketDetail,detailDividend,
    budlingInfo,publishInfo,boardInfo,detailBoardInfo,dayQuote,daliyQuote} from '../../controllers/market'
